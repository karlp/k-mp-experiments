...
class KMotor():
    ...
    def __init__(self, pin1, pin2, **kwargs):
        ...
        ddecay = dict(SLOW=0, FAST=1023)
        self.idle_state = ddecay.get(decay, ddecay["SLOW"])
        self.pin1 = pin1
        self.pin2 = pin2
    ...
    def forward(self, speed=50):
        ...
        self.p2.duty(self.idle_state)

    def back(self, speed=50):
        self.p1.duty(self.idle_state)
...
class Spider():
    ...
    async def move_to(self, position, speed=50):
        ...
        ev = self.encoder.wait_for(position, self.motor.stop)
